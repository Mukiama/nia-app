...
class PlacesResource(Resource):
    ...
    def post(self):
        ...
        try:
            new_place = PlaceSchema().load(data, session=db.session)
        ...
        return make_response(jsonify(PlaceSchema().dump(new_place)), 201)
...
class PlaceResource(Resource):
    ...
    def get(self, id):
        ...
        return make_response(jsonify(PlaceSchema().dump(place)), 200)
...
place_api.add_resource(PlacesResource, "/places", "/places/")
place_api.add_resource(PlaceResource, "/places/<int:id>", "/places/<int:id>/")
...
class PlaceCategoriesResource(Resource):
    ...
    def get(self):
        ...
        return make_response(jsonify(sorted([c[0] for c in categories if c[0]])), 200)

place_api.add_resource(PlaceCategoriesResource, "/places/categories", "/places/categories/")
